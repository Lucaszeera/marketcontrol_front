    ...
    return (
        ...
        <nav style={{ backgroundColor: "#F9F9F9" }} className='bg-fcfcfc p-4 flex justify-between'>
            <ul className='flex gap-12  items-end'>
                ...
                <li><Link className={active =="estoque" && "font-bold"} href="/estoque">Estoque</Link></li>
                <li><Link className={active =="produto" && "font-bold"} href="/cadastrarProduto">Cadastrar produto</Link></li>
                <li><Link className={active =="estabelecimento" && "font-bold"} href="/cadastrarEstabelecimento">Cadastrar Estabelecimento</Link></li>
            </ul>
